...
struct thread_pool_task {
        thread_fn          routine;          /* function to be run          */
        void               *argument;        /* parameters of the function  */
        thread_pool_task_t *next;            /* pointer to the next task    */
        thread_pool_task_t *prev;            /* pointer to the previous task*/
};
...
size_t task_queue_length(task_queue_t *queue);
...
int task_queue_peek(task_queue_t *queue, thread_pool_task_t *task);
